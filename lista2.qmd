...
```{r histograma-q2,fig.align='center', fig.caption = "Histograma da variável resposta", fig.height = 3}
dados %>%
  ggplot(aes(eficacia))+
...
```{r histograma-q2-facet,fig.align='center', fig.caption = "Histograma da variável resposta segregado por tratamento", fig.height = 2.5}
dados %>%
...
```{r scatter-variaveis, fig.align='center', fig.caption = "Gráficos de dispersão geral e segregado por tratamento"}
